...
| The room’s self-read | Group-level maturity in the room’s own eyes — informant data gathered aloud, recorded beside the team’s marks (the gap is data). Rooms, never people. | Set up at the quarter closes (Weeks 6, 11, 17); answered together at the re-entries (Weeks 7, 12, 18). First read: Week 7. |
