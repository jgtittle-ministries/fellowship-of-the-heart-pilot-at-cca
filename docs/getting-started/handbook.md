...
- Has heard the gospel stated plainly (the seed, Week 1), knows what this fellowship means by *saved* — the desire to be connected to Christ, acted on by turning to Him (the thief's case, Luke 23:39–43; Romans 10:9–10) — has privately examined whether that turning has happened in them (2 Corinthians 13:5, Week 2's question zero), and knows the quiet road to begin, or begin again, any week of the year.
...
- [x] **The door out is named.** One adult outside the Companion team, with a way to reach them, printed on the take-home page and announced aloud at Week 1 (Section 6, “The door out”). Name: **Pastor Bobby Gore** · Contact: **(831) 277-9878** · Number phone-verified by: **John G. Tittle, September 15, 2026** — role and after-hours protocol confirmed with Pastor Gore directly.
...
## Who we are when we measure — this is action research

Everything in this section is a kind of research, and it is worth naming which kind. This is **action research**: the people doing the studying are inside the thing being studied, the point of looking is to make the practice better rather than to hold it still, and looking and doing take turns all year long instead of standing apart from each other. It is the ordinary method of a practitioner who wants to know whether the work is working. (The tradition begins with Kurt Lewin in 1946; its theological form — treating a community’s own working theology as something to be surfaced rather than filtered out — is set out in Cameron and colleagues, *Talking About God in Practice*, SCM Press, 2010.)

That matters for how the team holds itself. **We are not a collection of scientists walking around in white lab coats with clipboards.** We are fellow pilgrims, engaged and caring, growing and being stretched along with everyone else in the room — maybe more than most, since we are the ones who signed the covenant. The watching is pastoral before it is anything else.

It also licenses something a stricter design would forbid: **we may change the thing while it is running.** If a week is not serving this group, we say so at the Thursday Call and we adjust — content, pace, emphasis — to best serve these families at this juncture. The train is moving, and we are allowed to fix the track.

And it costs something, which we name honestly rather than hide: **an observer inside the room cannot claim the distance of one outside it.** We will be tempted to see what we hope to see. That is exactly why the covenant is signed first, why the tiers are built so sources can disagree, why the room reads itself in its own unprompted words, and why *we do not yet know* is always an honest finding. Generalizations and extensions come later. This year we are learning one room.

**The reader from outside.** Every one of those safeguards is still ours, written by us and read by us, and none of them is positioned to notice what the whole team takes for granted. So once a quarter we ask someone outside the team to spend two hours with the published materials and one session, and to answer a single question: *judging only by what this program does, what does it appear to believe?* They see no debrief sheets, no journals and no verbatim notes — the covenant does not permit it, and it is not what we are asking them for. Their answer goes in the record as they gave it, whether or not we recognize ourselves in it, and the Thursday Call after each visit spends ten minutes on the gap between their sentence and ours. The method has a name for why this matters: theological action research is a partnership between insiders and outsiders, and a practitioner reporting alone is not doing it.

## The permission conversation — asked for, never administered

(Adopted for the pilot year, August 2026.) Every page a participant fills out — the Pre-Series Survey, the three Quarterly Pulses, the Post-Series Survey — is asked for before it exists in their world. In the days after Week 1, the Lead Companion sits with each family and asks, in plain words: *with your permission, I would like a before-and-after — one page now, one at year’s end, and three one-page check-ins at the quarter turns — so we can see whether this curriculum actually works.* We are grading the curriculum, never the family, and one yes covers the year; nothing is handed out until it is given. A family’s no costs nothing: they remain full participants and are never surveyed. What we promise about privacy is what we can actually keep: nobody is told who answered which way, nobody on the team asks, and no page is handed out or collected in front of the room. In a room of three to six families we do not promise that no one could ever notice — that would be a promise about other people’s eyes, and it is not ours to make. It is a promise about what we do. The Companion team’s own watching — the vital signs, the debrief notes, the observation profiles — is not a survey; it is a shepherd paying attention, held under the Measurement Covenant. What that watching keeps is said out loud in the same conversation, without waiting to be asked: the team keeps notes with names on them, a page per participant written four times across the year, holding what we notice and how we are praying, never a score, never read to the room. Permission that hides what is kept is not permission. Permission is asked for pages, never for care. The same conversation names the room’s self-read: *and once a quarter, we’ll turn our weekly feedback questions on ourselves as a group — out loud, never about any one person, no paper in anyone’s hand.*

## The room’s self-read — the group assesses the group

(Adopted with the permission conversation, August 2026.) Once a quarter, the room is asked to assess itself — never any person. The questions are set up at the quarter’s closing session and sent home on no paper — the Feedback Round’s own questions, turned on the group: *what’s working well that we ought to keep doing next quarter? what could we do differently that would make things even better? and what would you tell somebody else about what this group is like?* — and answered together at the re-entry, deliberately across the break, so the ones who think best in quiet arrive ready. The design leans on a distinction the ceiling argument itself makes: a heart is opaque to its owner, but a room is not opaque to its members — group behavior is public behavior, and every participant is an eyewitness to whether the circle held, who was noticed, what the silence did. The room’s read is informant data, gathered aloud — and deliberately unprompted: the room is never handed the signs to rate itself against, because what it spontaneously names as worth keeping is a truer read of what it values than any answer to a given category. The discipline: the leader answers first with a moment attached — the Feedback Round grown to quarter scale; bare verdicts are invited to their story (*say more — what did that look like?*); the third question is the teach-back’s sibling and the witness’s rehearsal — describing the group to an imagined somebody is where the truest read lives, and where next year’s invitations are quietly born; the room’s answers are recorded on the team’s debrief sheet, and at the Thursday Call the team maps them to the three vital signs on its own side of the paper — where that map and the ladder marks differ, the gap is data, never a correction issued to the room. No target is ever announced: a mirror that becomes a goal stops being a mirror. And the deeper purpose is formation.

**The trust beneath the signs.** What the three vital signs run on is trust, and trust has ages — a room holds together first because the container holds it (HELD), then because its people know each other (KNOWN), and finally because they have become each other’s people (OWNED), which is internalization visible at group scale. At the Thursday Call after each self-read, the team circles one of those three words on the week’s debrief sheet — the lowest honest answer — and listens to the tell-somebody answers for the room’s own trust vocabulary (“safe and well-run” is HELD language; “they know me there” is KNOWN; “these are my people” is OWNED). The full field guide, with the recognition examples and the two warnings — the first fight may be good news, and the sweet frictionless room may be the counterfeit — is the [Watching Trust Grow](../shared/watching-trust-grow.md) card. Like everything on the team’s side of the paper: never taught to the room, never a target, never about a person. A room that learns to see what it has begun to taste can choose it — the aim is a cohort that ends the year unwilling to go back to rooms that do not have this. That choosing, not any score, is the Level 2-to-3 transition happening in public.
...
v1.3 adds a standing closing element: the last five minutes of **every** session, the evening's leader — beginning with the Lead Companion at Week 1, and continuing with whoever led that night, adult or teen — says three things to the whole room: *what I think went well tonight*, *what I would do differently next time*, and — the teach-back — *if I were to teach tonight's process to someone, here is what I would tell them*. Then they invite the room to answer the first two questions about the evening. That is the whole liturgy. It is not a critique session and not a compliment round; it is the leader publicly staying a sheep, every single week — so that by the time any teen leads anything, they have watched the oldest person in the room receive correction a dozen times, and receiving it looks like strength because it has only ever been modeled as strength. The teach-back question is the round's third movement (added for the CCA year, August 2026): formulating what you would tell another person is one of the most reliable ways learning consolidates, and it turns the round into a weekly rehearsal of 2 Timothy 2:2 — the leader practices entrusting in the same breath the room practices honest feedback. On second-running nights the question lands in the mouth of the teen who just taught, which is the design working as intended. Every participant meets the same question privately as the standing final line of each week's journal reflection; at The Long Walk (Week 20) the Companions-in-Formation stop answering it on paper and teach the room. For assessment purposes the round doubles as a scheduled weekly instance of costly telling (the first vital sign) and belongs in the debrief notes. The leader holding the evening may drop the round in a given week if the room's energy needs something else — grief, celebration, lateness — but dropping it twice running is a flag for the team debrief, not a new normal.
...
| --- | --- | --- |
| Pre-Series Survey | Current spiritual practice frequency; hopes and expectations for the series. (Participants are not asked to self-score an Affective Taxonomy stage.) | At Family Orientation Night — or, when no orientation night fits the runway (the pilot year’s path), offered in the permission conversation after Week 1 and handed over only on the family’s yes; returns at the Week 2 door as they come. |
...
| The room’s self-read | The Feedback Round at quarter scale — keep, change, and what would you tell somebody about this group; the team maps the answers to the signs afterward (the gap is data). The group, never any one person. | Set up at the quarter closes (Weeks 6, 11, 17); answered together at the re-entries (Weeks 7, 12, 18). First read: Week 7. |
...
- **One thing tonight that did not go as I expected — and what I did in the moment.** Answered by whoever led, every week, in one or two sentences. This line is not about quality and is not a confession; it exists because what we actually believe shows up where the plan stopped holding, and that is the one place a team cannot see itself by trying harder. A week with no surprise is a legitimate answer, written as “none,” and a long run of them is worth a sentence at the Thursday Call.
...
A full **session slide deck** accompanies the plans — [Getting Started Session Slides, v1.5 (PowerPoint)](gs-session-slides-v1.5.pptx). Two hundred seventy-seven slides cover all twenty-two sessions, one slide per road stop, in big read-aloud type, with five standing images that repeat through the year like liturgy: the open bowl on every road, the trail cairn at every check-in (Joshua 4:21 printed beneath it at its first appearance and at both “What Held?” re-entries), the compass at every Leader Feedback Round, the seedling over every between-session practice, and the cream blessing card at every close. The deck serves the plans and never replaces them — the plan carries the evening; the screen only keeps the room from having to remember anything. This edition is the CCA pilot year’s (Wednesdays, four quarters, dated dividers); another body keeps the sessions and adapts the dividers and dates to its own calendar.
